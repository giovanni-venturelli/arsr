...
$htmlprint="$htmlprint
		...
		<div class='validation center'><img class='image2' src='../public_html/img/vcss.gif' alt='logo validazione css'/><img class='image2' src='../public_html/img/vxhtml.png' alt='validazione html'/><div class='break'></div></div></div>
	</div>
	$footer";
print($htmlprint);
